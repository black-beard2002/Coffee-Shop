...
function HeaderNav() {
  ...
  return (
    <nav className="w-full bg-white fixed z-50 h-[4.5rem] flex items-center font-poppins">
      ...
      >
        <a className={fixedClassName} onClick={()=>setIsOpen(false)} href="#home">Home</a>
        <a className={fixedClassName} onClick={()=>setIsOpen(false)} href="/menu">Menu</a>
        <a className={fixedClassName} onClick={()=>setIsOpen(false)} href="#about">About</a>
