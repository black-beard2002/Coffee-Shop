        ...
        <div className="flex flex-col lg:flex-row items-center mt-10 space-y-8 md:space-y-0 md:space-x-12">
          ...
          <div className="flex flex-1 flex-col space-y-6 text-center md:text-left">
            ...
            <p className="text-sm md:text-lg text-[#443] leading-relaxed">
              At our coffee shop, every cup is crafted with care, using only the
              finest, sustainably sourced beans. We roast in small batches to
              ensure maximum freshness, bringing out rich, unique flavors in
              every brew. Whether you're enjoying a bold espresso or a smooth
              latte, our attention to quality and passion for great coffee make
              every sip something truly special.
            </p>
    ...
    <motion.div key={item.id} variants={fadeInUp}>
      <ProductItem product={item} />
        ...
        transition-all duration-300"
            >
              Discover Menu
              <FontAwesomeIcon icon={faWineGlass} className="group-hover:rotate-45 duration-300"/>
            </button>
      </div>
